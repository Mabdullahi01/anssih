...
const DialogAddAnnoucement = () => {
  ...
  const onSubmit = () => {
    ...
    useAxios
      .post(endpoints.createAnnouncement, formData)
      .then(res => {
      ...
      >
        ...
        >
          ...
          <Box sx={{ mb: 8, textAlign: 'center' }}>
            ...
            <Typography variant='body2'>Please the title should be brief.</Typography>
          </Box>
...
export default DialogAddAnnoucement
