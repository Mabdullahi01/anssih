...
const TwoFactorAuthenticationCard = () => {
  ...
  const on2FAFormSubmit = (data: FormData) => {
    const { phoneNumber } = data
    useAxios
      .patch('/scholar/enable/mfa/' + phoneNumber)
      .then(res => {
      ...
      <Dialog fullWidth open={open} onClose={toggle2FADialog}>
        ...
        >
          ...
          <Typography sx={{ mt: 4, mb: 6 }}>
            Enter your mobile phone number we will send you a verification code before any login attempt, this number
            will override your current profile phone number
          </Typography>
